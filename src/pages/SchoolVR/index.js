...
const SchoolVR = (props) => {
  ...
  useEffect(()=>{
    ...
    if(sceneElem){
      ...
      onScroll = (s, y, h) => {
        ...
        document.querySelector('.pageNum').style.transform = `translate3d(0,${-document.querySelector('.pageNum > span').offsetHeight * page}px,0)`;

        if(page > 0){
          svrIcon.className = '';
          document.querySelector('.copyrightWrap').style.transform = `translate3d(0,0,0)`;
        }
        else{
          svrIcon.className = 'hide';
          document.querySelector('.copyrightWrap').style.transform = `translate3d(-${document.querySelector('.pages').offsetWidth + 15}px,0,0)`;
        }
      }
  ...
  return(
    <div>
      ...
      <a id="logo" href="https://ioiocreative.com" target="_blank">
      ...
      <div id="copyright">
        <div className="copyrightWrap">
          <div className="pages bold h5">
            <span>P</span>
            <div className="pageNumWrap">
              <span className="pageNum"><span>1</span><span>2</span><span>3</span><span>4</span><span>5</span><span>6</span><span>7</span><span>8</span></span>
            </div>
          </div>
