                ...
                value => {
                  ...
                  return (
                    <Switch>
                      ...
                      */}
                      <Route path={routes.lab(false)} render={passLanguageToAsyncLoadingComponentFunc(langCode, AsyncDarkSidebar, otherPropsObj)} />
                      <Route path={routes['sonar2019']} render={null} />
                      <Route path={routes['schoolVR']} render={null} />
                      <Route render={passLanguageToAsyncLoadingComponentFunc(langCode, AsyncBrightSidebar, otherPropsObj)} />
                    </Switch>
                  );
                }
              }
