...
function createDefaultShuffle(shuffleRef, itemSelectorClass) {
  return new Shuffle(shuffleRef, {
    // https://vestride.github.io/Shuffle/#options
    // overrideable options
    itemSelector: '.' + itemSelectorClass, // e.g. '.picture-item'.
...
export default createDefaultShuffle;